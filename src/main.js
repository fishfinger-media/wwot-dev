...
function transitionSlide(fromSlide, toSlide, direction) {
    ...
    gsap.timeline()
        .set('.slide_fade', { xPercent: direction === 'next' ? 0 : -200, backgroundColor: backgroundColorFrom })
        ...
        .to('.slide_fade', { xPercent: direction === 'next' ? -200 : 0, duration: 3, ease: "power4.inOut", backgroundColor: backgroundColorTo })
